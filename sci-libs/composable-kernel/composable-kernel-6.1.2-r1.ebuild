...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-6.1.2-by-default-no-3RD_DWORD-support-for-not-listed-gpus.patch
	"${FILESDIR}"/${PN}-6.1.2-gfx1010-1035-1036-and-1103-initial-support.patch
	"${FILESDIR}"/${PN}-6.1.2-gfx1031-1035-1036-and-1103-more-detailed-support.patch
)

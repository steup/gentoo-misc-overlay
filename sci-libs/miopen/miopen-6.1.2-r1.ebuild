...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-6.1.2-Do-not-fail-on-install-for-missing-kdb.bz2-file.patch
	"${FILESDIR}"/${PN}-6.1.2-gfx1010-and-gfx1035-support.patch
	"${FILESDIR}"/${PN}-6.1.2-improved-gfx1010-support.patch
	"${FILESDIR}"/${PN}-6.1.2-gfx1036-and-gfx1103-support.patch
)

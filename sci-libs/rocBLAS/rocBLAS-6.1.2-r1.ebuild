...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-6.1.2-add-gfx1035-gfx1036-and-gfx1103-to-gpulist.patch
	"${FILESDIR}"/${PN}-6.1.2-add-amd-phoenix-gfx1103-logic-files.patch
	"${FILESDIR}"/${PN}-6.1.2-add-rembrandt-rocBLAS-logic-files.patch
	"${FILESDIR}"/${PN}-6.1.2-add-raphael-rocBLAS-logic-files.patch
	)
